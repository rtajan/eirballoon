...
Synchronizer_Gardner<B, R>
::Synchronizer_Gardner(const int N, int osf, const R damping_factor, const R normalized_bandwidth, const R detector_gain)
: Synchronizer_timing<B,R>(N, osf),
farrow_flt(N,(R)0),
strobe_history(0),
TED_error((R)0),
...
template <typename B, typename R>
Synchronizer_Gardner<B, R>
::~Synchronizer_Gardner()
{
}

template <typename B, typename R>
void Synchronizer_Gardner<B, R>
::_synchronize(const R *X_N1, R* MU, R *Y_N1, B *B_N1, const int frame_id)
{
...
template class aff3ct::module::Synchronizer_Gardner<int, float>;
template class aff3ct::module::Synchronizer_Gardner<int, double>;
// ==================================================================================== explicit template instantiation
