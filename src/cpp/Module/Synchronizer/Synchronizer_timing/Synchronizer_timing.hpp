...
public:
	...
	virtual void step(const std::complex<R> *X_N1, R* MU, std::complex<R>* Y_N1, B* B_N1) = 0;
...
protected:
	...
	virtual void _synchronize(const R *X_N1, R* MU, R* Y_N1, B * B_N1, const int frame_id) = 0;
